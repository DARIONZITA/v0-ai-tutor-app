...
export function Sidebar({ 
  ...
  return (
  <aside className="w-80 bg-white border-r border-gray-200/50 flex flex-col shadow-sm h-screen min-h-0 lg:sticky lg:top-0 lg:self-start lg:max-h-screen">
      {/* Header */}
      <div className="p-4 lg:p-6 border-b border-gray-200/50 sticky top-0 z-10 bg-white">
